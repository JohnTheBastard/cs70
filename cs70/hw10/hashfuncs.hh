...
extern unsigned int	hashStringCRC(const std::string& key);
				// Hash a string using the fake-CRC XOR method
extern unsigned int	hashStringBase256(const std::string& key,
			  unsigned int tableSize);
				// Hash a string by interpreting it in base 256
extern unsigned int	hashPJW(const std::string& key);
...
extern unsigned int	hashStringBUZ(const std::string& key);
...
extern unsigned int	hashStringPreiss(const std::string& key);
				// Hash a string using Preiss's method
extern unsigned int	hashStringWeiss1(const std::string& key);
				// Hash a string using Weiss's first method
extern unsigned int	hashStringWeiss2(const std::string& key);
				// Hash a string using Weiss's second method
extern unsigned int	hashStringFNV(const std::string& key);
